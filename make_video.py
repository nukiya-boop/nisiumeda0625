...
SCENES = [
    {
        ...
        'telops': [
            ...
            {'text': '職　人　の　技',                'style': 'main',     'y_ratio': 0.42},
            {'text': '鰻・鱧　夏の傑作コース',         'style': 'sub',      'y_ratio': 0.52},
            {'text': '── 2026 Summer ──',           'style': 'caption',  'y_ratio': 0.57},
        ],
    ...
    },
    {
        ...
        'telops': [
            ...
            {'text': '炭火でじっくり、丁寧に焼き上げた', 'style': 'sub',      'y_ratio': 0.85},
            {'text': '職人の一品',                    'style': 'accent',   'y_ratio': 0.91},
        ],
    ...
    },
    {
        ...
        'telops': [
            ...
            {'text': '繊細な包丁さばきで仕上げる',      'style': 'sub',      'y_ratio': 0.85},
            {'text': '夏の風物詩',                    'style': 'accent',   'y_ratio': 0.91},
        ],
        'duration': 5, 'zoom': 0.05,
    },
    {
        ...
        'telops': [
            ...
            {'text': '市場で選び抜いた旬の鮮魚',        'style': 'sub',      'y_ratio': 0.85},
            {'text': '四種盛り合わせ',                 'style': 'accent',   'y_ratio': 0.91},
        ],
        'duration': 5, 'zoom': 0.05,
    },
    {
        ...
        'telops': [
            ...
            {'text': '職人の技と目利きで選んだ',        'style': 'sub',      'y_ratio': 0.83},
            {'text': '旬のものを使ったコース料理です',   'style': 'sub',      'y_ratio': 0.89},
        ],
        'duration': 5, 'zoom': 0.05,
    },
    {
        ...
        'telops': [
            {'text': '季節限定',                     'style': 'badge',    'y_ratio': 0.08},
            {'text': '一期一会のひと皿を',             'style': 'main',     'y_ratio': 0.42},
            {'text': 'ぜひご賞味ください',             'style': 'sub',      'y_ratio': 0.52},
            {'text': '── ご予約お待ちしております ──', 'style': 'caption',  'y_ratio': 0.57},
        ],
        'duration': 5, 'zoom': 0.06,
    },
]
